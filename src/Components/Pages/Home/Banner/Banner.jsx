        ...
        <div className="flex flex-col md:flex-row justify-center items-center h-full gap-20">
          <div className="text-white md:w-[50%]">
            <div className="px-3 lg:px-0 space-y-5">
              <h1 className="text-4xl lg:text-7xl font-extrabold leading-snug md:leading-normal">
                Give <span className="text-red-700">Blood</span> and Save Lives.
              </h1>
              <p className="text-xl lg:text-3xl h-20">
                <TypeAnimation
                  sequence={[
                    // Same substring at the start will only be typed out once, initially
                    "Donate Blood Today! Your generostiy can save lives. Join us in making a difference - one drop at a time.",
                    1000, // wait 1s before replacing "Mice" with "Hamsters"
                    "Save lives, be a hero! Donate blood today. Your one act of kindness can make a world of difference. 💪🩸"
                  ]}
                  wrapper="span"
                  speed={60}
