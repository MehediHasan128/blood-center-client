...
const Registration = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (password === checkPassword) {
      ...
      if (res.data.success) {
        createUser(donerEmail, password).then((result) => {
          ...
          if (user.uid) {
            ...
            axiosSecure.post("/users", donerInformation).then((res) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen container mx-auto">
      <Helmet>
        <title>Blood Center/Registration</title>
      </Helmet>
      <div className="flex flex-col lg:flex-row lg:w-[80%] mx-auto">
        ...
        <div className="lg:w-[50%] bg-slate-50 dark:bg-zinc-700 py-14">
          ...
          >
            ...
            <div className="px-5 py-2 flex items-center gap-3 border rounded-md">
              <select
                className="bg-slate-50 dark:bg-zinc-700 px-5 py-2 w-full focus:outline-none"
                {...register("bloodGroup")}
              >
